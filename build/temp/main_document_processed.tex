...
\begin{iobox}{Expected Output}
type(convert\_score): <class 'function'> \\
type(EmptyBox): <class 'type'> \\
type(EmptyBox()): <class '\_\_main\_\_.EmptyBox'> \\
\end{iobox}
...
dir(result) sample: ['\_\_bool\_\_', '\_\_class\_\_', '\_\_delattr\_\_', '\_\_dir\_\_', '\_\_doc\_\_'] \\
\end{iobox}
...
\begin{iobox}{Expected Output}
type(nums): <class 'list'> \\
type(even\_nums): <class 'filter'> \\
dir(even\_nums) sample: ['\_\_class\_\_', '\_\_delattr\_\_', '\_\_dir\_\_', '\_\_doc\_\_', \\
'\_\_eq\_\_', '\_\_format\_\_', '\_\_ge\_\_', '\_\_getattribute\_\_', '\_\_getstate\_\_', \\
'\_\_gt\_\_', '\_\_hash\_\_', '\_\_init\_\_'] \\
has \_\_iter\_\_: True \\
has \_\_next\_\_: True \\
\end{iobox}
...
\begin{codebox}[]{python}{The Anatomy of Function Code Objects: Inspecting Bytecode Attributes (\_\_cod...}{str02}
...
\begin{iobox}{Expected Output}
co\_argcount:    2 \\
co\_varnames:    ('name', 'number', 'text') \\
co\_consts:      (None, ' says ') \\
co\_names:       ('upper',) \\
co\_code length: 58 \\
\end{iobox}
...
\begin{iobox}{Expected Output}
add\_def: type=<class 'function'>, vars=('x',), consts=(None, 42), result=50 \\
add\_lambda: type=<class 'function'>, vars=('x',), consts=(None, 42), result=50 \\
\end{iobox}
...
\begin{iobox}{Expected Output}
n=42, co\_name=show\_frame, locals=['n', 'frame'], f\_back=True \\
\end{iobox}
...
\begin{iobox}{Expected Output}
fn(): D'oh! \\
co\_cellvars: ('message',) \\
co\_freevars: ('message',) \\
...
\begin{iobox}{Expected Output}
gi\_frame before next: <frame at 0x..., file "...", line 1, code small\_gen> \\
f\_locals: {} \\
yielded: "D'oh!", gi\_frame after: None \\
\end{iobox}
