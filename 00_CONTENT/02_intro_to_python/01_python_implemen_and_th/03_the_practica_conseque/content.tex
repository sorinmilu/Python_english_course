...
Therefore, both facts should be held at once. Python is a language with multiple possible execution backends. CPython is the dominant reference runtime that gives ordinary Python its concrete behavior in most real installations.
